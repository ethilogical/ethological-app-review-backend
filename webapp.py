...
app_reviews = {
    "1": {
        ...
        "icon": "heart.png",
        "description": "reliefQueue raises funds from its charitable users for the causes currently in the most need. Organizations create a profile with reliefQueue and share statistics such as humanitarian impact, charitable commitment, fundraising efficiency, and current demand of their cause/charity. Our algorithm measures and compares these factors and promotes charities of the most need to the top of the reliefQueue. Organizations of exceptional need can be “prompted” to the top of reliefQueue by developers.",
        "next": "2"
    },
    "2": {
        "title": "Lorem ipsum",
